...
LANGS['en'] = dict(
    ...
    menu_groups=[
        ('MAZESOBA (no soup)', [
            ...
            ('Buttoi Jiro (Jiro-style, piled high)', '1,380 yen'),
        ]),
        ('EXTRAS FOR BUTTOI JIRO ONLY', [
            ('Extra vegetables', '200 yen'),
            ('Extra back fat', '300 yen'),
            ('Extra chopped garlic', '50 yen'),
            ('All three of the above', '400 yen'),
        ]),
        ('RAMEN (with soup)', [
        ...
        ('TOPPINGS', [
            ...
            ('Back fat', '300 yen'),
            ('Kimchi / mayonnaise / extra spring onion / rice / egg / yamitsuki negi', '150 yen each'),
        ]),
        ('DRINKS', [
